...
- [] You will also buy accessories for each phone as long as your purchase amount is below your mental spending threshold.
- [] After you have calculated your purchase amount, add in the tax, then print out
...
afford it or not.
- [] You should set up some constants for:
      * "tax rate"
      * "phone price"
      * "accessory price"
      * "spending threshold"
